...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function translateSpeach(text) {
    ...
    formData.append("lang", "es"); // Append the target language
  ...
  function startRecognition() {
    ...
    recognition.lang = "en"; // Set language for recognition
  ...
  function speakText(text) {
    ...
    speech.lang = "es"; // Set the language based on user selection
    speech.onstart = () => {};
    speech.onend = () => {};
